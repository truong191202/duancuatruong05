...
// Xu ly tang giam so luong san pham
const moreProduct = $(".quantity .choose button:nth-child(4)")
const lessProduct = $(".quantity .choose button:nth-child(2)")
const numberProduct = $(".quantity .choose p:nth-child(3)")
...
addProductSuccess.onclick = () => {
	...
	// Tao ra productCurrentArray co luong san pham va thong tin san pham tuong ung voi lua chon cua khach hang
	for(let i = 0; i < parseInt(numberProduct.innerHTML); i++){
		productCurrentArray = productCurrentArray.concat(productNewArray)
	}
	// Truyen di productCurrentArray vua tao ra
...
const rowVideo = $$(".video-summary .video-row")
const videoSummary = $$(".video-summary .video-row video")
const titleVideoSummary = $$(".video-summary .video-row p")
